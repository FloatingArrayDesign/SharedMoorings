...
---------------------- INPUT FILES --------------------------------------------- 
"IEA-15-240-RWT_INOSemiUpscaled_ElastoDyn.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string) 
...
"../CommonFiles/IEA-15-240-RWT_AeroDyn15.dat"  AeroFile     - Name of file containing aerodynamic input parameters (quoted string) 
...
"IEA-15-240-RWT_INOSemiUpscaled_HydroDyn.dat"      HydroFile       - Name of file containing hydrodynamic input parameters (quoted string) 
"none"                 SubFile         - Name of file containing sub-structural input parameters (quoted string) 
"IEA-15-240-RWT_INOSemiUpscaled_MoorDynTaut.dat"      MooringFile     - Name of file containing mooring system input parameters (quoted string) 
